            ...
            for (let hotspotRestaurant of hotspotRestaurants) {
                ...
                if(nextDeliveryTime){
                    ...
                    if (orders.length > 0) {
                        ...
                        console.log("timeDiff:",timeDiff,moment().tz(process.env.TIME_ZONE).format('HH:mm:ss'),moment(cutOffTime).format('HH:mm:ss'),moment().tz(process.env.TIME_ZONE).diff(moment(cutOffTime),"seconds"))
                        // if (timeDiff > 0) {
